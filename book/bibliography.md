...
title: "Bibliography"
description: >-
  Single source of truth for the textbook's full citations — the empirical
  classics referenced in Weeks 5 and 6, the Gao papers threaded through
  Weeks 3 – 8, and the methodology papers cited in the Chapter Reader's
  Guides.
---
...
This page is the canonical home for the textbook's full citation list, but
the central `refs.bib` has not yet been committed (see `_quarto.yml`, line 41:
"Bibliography: no central .bib yet"). Until then, citations live inline in
each chapter's Reader's Guide and in the wiki's
[Reading list](../wiki/resources/reading.html).

The structure below is the intended layout. Each entry will be replaced with a
full citation (authors, year, title, journal, volume, pages, DOI / JSTOR / SSRN
link) once the central `.bib` file lands.
:::

---

## A — Empirical-finance classics (Weeks 5–6)

These five papers are the "anchor canon" the cohort reads cover-to-cover in
Weeks 5 and 6. Reader's Guides for each are in `book/weeks/week-05/` and
`book/weeks/week-06/`.

- **Fama, E. F. & French, K. R. (1992).** *The Cross-Section of Expected Stock
  Returns.* Journal of Finance **47**(2), 427–465.
  JSTOR: <https://www.jstor.org/stable/2329112>
...
- **Jegadeesh, N. & Titman, S. (1993).** *Returns to Buying Winners and
  ...
  JSTOR: <https://www.jstor.org/stable/2328882>
- **Petersen, M. A. (2009).** *Estimating Standard Errors in Finance Panel
  ...
  435–480. DOI: <https://doi.org/10.1093/rfs/hhn053>
- **Bertrand, M., Duflo, E., & Mullainathan, S. (2004).** *How Much Should We
  ...
  **119**(1), 249–275. DOI: <https://doi.org/10.1162/003355304772839588>

## B — Text, AI, and alternative-data canon (Week 6)

- **Kogan, L., Papanikolaou, D., Seru, A., & Stoffman, N. (2017).**
  *Technological Innovation, Resource Allocation, and Growth.* Quarterly
...
- **Bartlett, R., Morse, A., Stanton, R., & Wallace, N. (2022).** *Consumer-Lending
  ...
  **143**(1), 30–56. DOI: <https://doi.org/10.1016/j.jfineco.2021.05.047>
...
Cited in passing from the chapter Reader's Guides and from the appendices.
Full citations TBD; this list is illustrative, not exhaustive.

- Angrist, J. D. & Pischke, J.-S. (2009). *Mostly Harmless Econometrics.*
- Callaway, B. & Sant'Anna, P. H. C. (2021). *Difference-in-Differences with
  Multiple Time Periods.*
- Cattaneo, M. D., Idrobo, N., & Titiunik, R. (2019/2020). *A Practical
...
When this page and an in-chapter citation disagree, **this page wins** once
the central `.bib` file is committed. Until then, the in-chapter citation in
the relevant Reader's Guide is canonical for that paper. The wiki's
[Reading list](../wiki/resources/reading.html) mirrors the short
descriptions but never the full citation.
:::
