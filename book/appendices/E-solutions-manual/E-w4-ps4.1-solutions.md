...
**(a) (5 pts)** With event time $k=t-t_i^{\ast}$ ($t_i^{\ast}$ = first treated year for unit $i$), the event-study / leads-and-lags specification is
$$
